...
from bet_scraper.bet_scraper.spiders.inkabet_result_spider import InkabetResultSpider
            ...
            if bet_rows.exists():
                ...
                for bet_row in bet_rows:
                    if bet_row.match.is_suspended():
                        ...
                        logger_inkabet_results.info("Suspended match: %s", bet_row.match.get_logger_info())
