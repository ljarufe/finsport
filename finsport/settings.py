...
API_FOOTBALL_MAX_RETRIES = env.int("API_FOOTBALL_MAX_RETRIES", default=1)
...
FOOTBALL_MODERNIZED_R45_ENABLED = env.bool(
    "FOOTBALL_MODERNIZED_R45_ENABLED", default=False
)
...
FOOTBALL_CAPTURE_MANDATORY_RESERVE = env.int(
    "FOOTBALL_CAPTURE_MANDATORY_RESERVE", default=0
)
...
FOOTBALL_CAPTURE_DISCOVERY_ENABLED = env.bool(
    "FOOTBALL_CAPTURE_DISCOVERY_ENABLED", default=True
)
...
FOOTBALL_CAPTURE_RESULT_DELAY_MINUTES = env.int(
    "FOOTBALL_CAPTURE_RESULT_DELAY_MINUTES", default=130
)
FOOTBALL_CAPTURE_RESULT_CADENCE_MINUTES = env.int(
    "FOOTBALL_CAPTURE_RESULT_CADENCE_MINUTES", default=30
)
...
INKABET_AUTOMATIC_ENABLED = env.bool("INKABET_AUTOMATIC_ENABLED", default=False)
